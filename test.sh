...
for ((receivers=1; receivers<=20; receivers+=1)); do
    ...
    result=$(python3 main.py --protocol ivy --nbr_processes $receivers --message_count $message_count --port 10.34.127.255:2992 --length $length --log_level FATAL | tail -n 1)
