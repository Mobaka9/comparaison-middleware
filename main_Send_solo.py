...
def main():
    ...
    main_send(param.protocol, param.message_count, param.port, param.length, queue, logger, param.sleep, param.flag, param.flag_count, param.nbr_processes, param.direct_msg, param.device)
